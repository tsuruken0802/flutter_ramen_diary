...
class AddBirthdayBloc extends Bloc<MapEvent, MapState> {
  late final MapService _service;

  AddBirthdayBloc() : super(const MapState(title: "")) {
  ...
  _onRequestLocationPermission(
    ...
    // emit(state.copyWith(dto: state.dto.copyWith(name: event.name)));
  }
